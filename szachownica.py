...
szachownica = [[sg.Button(size=(4,3), key = (i, j), pad = (0,0), button_color = color(i, j)) for j in range(8)] for i in range(8)]
...
layout = [[sg.Column(szachownica, element_justification = 'c'), sg.Column(info, element_justification = 'c')],
